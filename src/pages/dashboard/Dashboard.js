...
import { MdDashboardCustomize,MdOutlinePersonOutline,MdFormatAlignCenter } from "react-icons/md";
...
const Dashboard = ()=>{
    ...
    return <div className="dashboard-container" >
        <div className="dashboard-container-left" >
                ...
                <div className="dashboard-container-left-item" style={{borderRight:"2px solid #4DC36B"}}>
                ...
                <div style={{border:"1px solid #ECEDF0",padding:"10px"}}>
                    ...
                    <div style={{margin:"2px 0px",display:"flex",flexDirection:"row",alignItems:"center"}}>
                        <p style={{fontSize:"12px",color:"#404146"}}>30 days left</p>
                        <div style={{marginLeft:"2px",display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center"}}>
                        <GoArrowRight />
                        </div>
                    </div>
